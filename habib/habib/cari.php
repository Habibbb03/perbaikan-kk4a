    ...
    <div class="container">
        <nav class="navbar navbar-expand-lg navbar-light bg-white">
            <div class="container-fluid">
                <a class="navbar-brand" href="index.php">Habib</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="d-flex" method="POST" action="cari.php">
        ...
        <div class="row mt-3" id="load_data">
            <?php
              include './koneksi.php';
              $cari=$_POST['cari'];
              $result = mysqli_query($db1, "select * from buku where judul_buku = '$cari'");
              ...
              while($baris = mysqli_fetch_array($result))
            {
              ...
              <div class='col-sm-3 mb-3' >
                  <div class='card'>
                        <img src='images/$baris[4]' alt='gambar'>
                        <div class='card-body text-decoration-none'>
                            <h5 class='card-title'> $baris[1]</h5>
                            <p class='card-text text-decoration-none'> $baris[2]</p>
                            <p class='card-text text-decoration-none'> $baris[3]</p>        
                        </div>
                                       
                        <div class='card-footer'>
                            <a href='ubah_buku.php?id_buku=$baris[0]' class='btn btn-warning btn-sm'>Edit</a>
                            <a href='hapus_buku.php?id_buku=$baris[0]' class='btn btn-danger btn-sm'>Hapus</a>
                            </div>
                        </div>
                   </div>
                </div>
